...
export type CreateCheckoutIdMutation = {
    __typename?: "Mutation";
    createCheckout?: { __typename?: "Checkout"; accountId: string } | null;
};
...
export const CreateCheckoutIdDocument = gql`
    mutation CreateCheckoutId($id: String!) {
        createCheckout(data: { accountId: $id }) {
            accountId
        }
    }
`;
export type CreateCheckoutIdMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useCreateCheckoutIdMutation(
    baseOptions?: Apollo.MutationHookOptions<CreateCheckoutIdMutation, CreateCheckoutIdMutationVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useMutation<CreateCheckoutIdMutation, CreateCheckoutIdMutationVariables>(
...
export type CreateCheckoutIdMutationOptions = Apollo.BaseMutationOptions<
    CreateCheckoutIdMutation,
    CreateCheckoutIdMutationVariables
>;
